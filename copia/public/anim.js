...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var e,
    ...
    w = (function (e) {
      for (
        var t =
            -1 !==
              (window ? window.location.href : "https://css-tricks.com/").indexOf(
  ...
  function l(e, t, r, o, i, s) {
    return (
      (r = (parseFloat(r || 0) - parseFloat(e || 0)) * i),
  ...
  function c(e) {
    return (
      ("string" != typeof e && e.nodeType) ||
        ((e = _gsScope.TweenLite.selector(e)).length && (e = e[0])),
      e
    );
  }
  function y(e) {
    ...
    if (
      ((r && (r.width || r.height)) ||
        ("rect" !== h && "circle" !== h && "ellipse" !== h) ||
        ((r = {
          width: parseFloat(
            e.getAttribute("rect" === h ? "width" : "circle" === h ? "r" : "rx")
          ),
          height: parseFloat(
            e.getAttribute(
              "rect" === h ? "height" : "circle" === h ? "r" : "ry"
            )
          ),
        }),
        "rect" !== h && ((r.width *= 2), (r.height *= 2))),
      "path" === h)
    )
      ...
      for (
        o = e.getAttribute("points").match(g) || [],
  ...
  ((e = _gsScope._gsDefine.plugin({
    ...
    init: function (e, t, r, o) {
      ...
      if (w)
        return (
          (window.location.href =
            "http://" + S + m + "?plugin=" + C + "&source=codepen"),
          !1
        );
      var i,
        s,
      ...
      return (
        ...
        -1 === (c = h.indexOf(" "))
          ? ((g = void 0 !== d ? d + "" : h), (l = h))
          : ((g = h.substr(0, c)), (l = h.substr(c + 1))),
        (g = -1 !== g.indexOf("%") ? (parseFloat(g) / 100) * f : parseFloat(g)),
        (s =
          (l =
            -1 !== l.indexOf("%") ? (parseFloat(l) / 100) * f : parseFloat(l)) <
          g
            ? [l, g]
            : [g, l]),
        (this._length = u + 10),
        0 === i[0] && 0 === s[0]
          ? ((n = Math.max(1e-5, s[1] - u)),
            (this._dash = u + n),
        ...
        _ &&
          (a = p(e)).strokeLinecap !== a.strokeLinejoin &&
          ((s = parseFloat(a.strokeMiterlimit)),
          this._addTween(
            e.style,
            "strokeMiterlimit",
            s,
