    ...
    (function () {
      var t = 180 / Math.PI,
        ...
        _ = function (t, s, r, n) {
          ...
          if (n)
            for (t = [n].concat(t), h = t.length; --h > -1; )
              "string" == typeof (c = t[h][s]) &&
                "=" === c.charAt(1) &&
                (t[h][s] = n[s] + Number(c.charAt(0) + c.substr(2)));
          if (((o = t.length - 2), 0 > o))
        ...
        c = function (t, e, i) {
          ...
          for (l = v.length; --l > -1; ) {
            for (
              c = v[l], m[c] = h = [], f = 0, u = t.length, _ = 0;
              u > _;
              _++
            )
              (s =
        ...
        f = function (t, e, i) {
          for (
            var s, r, n, a, o, h, l, _, u, c, f, p = 1 / i, m = t.length;
            --m > -1;
    ...
    _gsScope._gsDefine(
      ...
      function (t, e) {
        ...
        var ue = function (t, e, i, s) {
          ...
          ge = 9;
        for (l = pe.prototype, l.l = l.pr = 0; --ge > 0; )
          (l["xn" + ge] = 0), (l["xs" + ge] = "");
        (l.xs0 = ""),
          (l._next =
            l._prev =
        ...
        var xe,
          ...
          Ne = (B.getTransform = function (t, i, s, n) {
            ...
            var o,
              ...
              d = 1e5,
              g = Se
                ? parseFloat(Q(t, ke, i, !1, "0 0 0").split(" ")[2]) ||
                  f.zOrigin ||
                  0
                : 0,
              v = parseFloat(a.defaultTransformPerspective) || 0;
            if (
              ((f.svg = !(!t.getBBox || !ze(t))),
              f.svg &&
                (Me(
                  t,
                  Q(t, ke, r, !1, "50% 50%") + "",
              ...
              if (16 === o.length) {
                ...
                (f.x = o[4] || 0),
                  ...
                  Se &&
                    ...
                    (f.scaleZ = 1)),
                  f.svg &&
                    ((f.x -= f.xOrigin - (f.xOrigin * j + f.yOrigin * q)),
                      ...
                      ? ((R *= z),
                        ...
                        E &&
                          ...
                          xe &&
                            ...
                            ((m = this.t.getBBox()),
                            (I += 0.01 * k.xPercent * m.width),
                            (F += 0.01 * k.yPercent * m.height)),
                          (m = 1e-6),
                          m > I && I > -m && (I = 0),
                          m > F && F > -m && (F = 0)),
                        (T =
              ...
              parser: function (t, e, i, s, n, o, h) {
                ...
                if ("string" == typeof b.transform && be)
                  (u = L.style),
                    ...
                    null != b.xPercent &&
                      (l.xPercent = ne(b.xPercent, y.xPercent)),
                    null != b.yPercent &&
                      (l.yPercent = ne(b.yPercent, y.yPercent));
                  ...
                  "string" == typeof b.x &&
                    -1 !== b.x.indexOf("%") &&
                    ((l.x = 0), (l.xPercent = ne(b.x, y.xPercent))),
                    "string" == typeof b.y &&
                      -1 !== b.y.indexOf("%") &&
                      ((l.y = 0), (l.yPercent = ne(b.y, y.yPercent))),
                    (l.rotation = ae(
                      "rotation" in b
                        ? b.rotation
                        : "shortRotation" in b
                    ...
                    (l.skewX =
                      null == b.skewX ? y.skewX : ae(b.skewX, y.skewX)),
                    (l.skewY =
                      null == b.skewY ? y.skewY : ae(b.skewY, y.skewY)),
                    (_ = l.skewY - y.skewY) &&
                ...
                return (
                  ...
                  p &&
                    (s._transformType =
                      (y.svg && xe) || (!f && 3 !== this._transformType)
                        ? 2
                        : 3),
                  n
                );
                    ...
                    (d && P.test(f))
                      ? (d ||
                          ...
                          (f =
                            ...
                            f.join(",") +
                            ")")),
                        (i = de(v, a, c, f, !0, "transparent", i, 0, n)))
        ...
        init: function (i, s) {
          ...
          for (r in s)
            (this._start[r] = this._proxy[r] = n = i.getAttribute(r) + ""),
              ...
              this._addTween(this._proxy, r, parseFloat(n), a, r) ||
                (this._suffix[r] = ""),
              "=" === a.charAt(1) &&
                (this._end[r] = this._firstPT.s + this._firstPT.c + o),
                  ...
                  n
                    ? "string" != typeof n
                      ? n.length &&
                        ...
                        : ((this._siblings[r] = G(n, this, !1)),
                          1 === h &&
                            this._siblings[r].length > 1 &&
                            Z(n, this, null, 1, this._siblings[r]))
                      : ((n = a[r--] = D.selector(n)),
        ...
        (n._initProps = function (e, i, s, r) {
          ...
          for (n in this.vars) {
            if (((_ = this.vars[n]), B[n]))
              ...
              E[n] &&
              (h = new E[n]())._onInitTween(e, this.vars[n], this)
            ) {
              for (
                this._firstPT = l =
                  {
